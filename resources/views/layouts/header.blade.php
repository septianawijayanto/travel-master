...
<a href="#" class="logo">
  ...
  <span class="logo-lg"><b>Kerinci Mulya</b></span>
</a>
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown notifications-menu">
        ...
        <ul class="dropdown-menu">
          ...
          <li class="footer"><a href="{{ url('/tblpemesanan') }}">View all</a></li>
        </ul>
      </li>
      ...
      <li class="dropdown user user-menu">
        ...
        <ul class=" dropdown-menu">
          ...
          <li class="user-footer">
            <div class="pull-left">
              <a href="{{ url('/profil') }}" class="btn btn-default btn-flat menu-sidebar">Profile</a>
            </div>
